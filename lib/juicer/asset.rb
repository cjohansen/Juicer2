...
module Juicer
  ...
  #   
  #   asset = Juicer::Asset.new "../images/logo.png", :document_root
  ...
  #
  class Asset
    # Base directory to resolve relative path from, see Juicer::Asset#initialize
    attr_reader :base

    # Hosts served from <tt>:document_root</tt>, see Juicer::Asset#initialize
    attr_reader :hosts

    # Directory served as root through a web server, see Juicer::Asset#initialize
